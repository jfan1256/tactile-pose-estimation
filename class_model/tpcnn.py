...
class TPCNN(nn.Module):
    ...
    def forward(self, tactile, heatmap, keypoint):
        ...
        heatmap_transform = remove_small(heatmap_out.transpose(2, 3), 1e-2, tactile.device) # --> heatmap_transform.shape = (batch_size, channel=21, height=20, width=20, depth=18)
